...
ERenderAPI VulkanDevice::GetAPI() { return ERenderAPI::Vulkan; }
void* VulkanDevice::GetNativeDevice() { return m_Device; }
void* VulkanDevice::GetNativeContext() { return nullptr; }
DeviceDesc& VulkanDevice::GetDesc() { return m_Desc; }

VulkanDevice* VulkanDevice::Create(DeviceDesc& desc)
{
...
void VulkanDevice::Resize(u32 w, u32 h)
{
    m_Desc.Width = w;
    m_Desc.Height = h;
    // Full swap chain recreation would go here
}

void VulkanDevice::ClearRenderTarget(Texture* rt, const f32 color[4])
{
    (void)rt; (void)color;
}

void VulkanDevice::ClearDepthStencil(Texture* ds, f32 depth, u8 stencil)
{
    (void)ds; (void)depth; (void)stencil;
}

void VulkanDevice::SetViewport(ViewportDesc& vp)
{
    (void)vp;
}

void VulkanDevice::SetScissorRect(Rect2D& rect)
{
    (void)rect;
}

void VulkanDevice::SetPipeline(Pipeline* pipeline)
{
    (void)pipeline;
}

void VulkanDevice::SetVertexBuffer(Buffer* buffer, u32 slot)
{
    (void)buffer; (void)slot;
}

void VulkanDevice::SetIndexBuffer(Buffer* buffer)
{
    (void)buffer;
}

void VulkanDevice::SetConstantBuffer(Buffer* buffer, u32 slot, EShaderType shader)
{
    (void)buffer; (void)slot; (void)shader;
}

void VulkanDevice::SetRenderTargets(Texture* const* renderTargets, u32 count, Texture* depthStencil)
{
    (void)renderTargets; (void)count; (void)depthStencil;
}

void VulkanDevice::SetShaderResource(Texture* texture, u32 slot, EShaderType shader)
{
    (void)texture; (void)slot; (void)shader;
}

void VulkanDevice::SetUnorderedAccessView(Texture* texture, u32 slot, EShaderType shader)
{
    (void)texture; (void)slot; (void)shader;
}

void VulkanDevice::SetBlendState(bool enable, EBlendFactor srcFactor, EBlendFactor dstFactor)
{
    (void)enable; (void)srcFactor; (void)dstFactor;
}

void VulkanDevice::Draw(u32 vertexCount, u32 startVertex)
{
    (void)vertexCount; (void)startVertex;
}

void VulkanDevice::DrawIndexed(u32 indexCount, u32 startIndex, u32 baseVertex)
{
    (void)indexCount; (void)startIndex; (void)baseVertex;
}

void VulkanDevice::Dispatch(u32 groupX, u32 groupY, u32 groupZ)
{
